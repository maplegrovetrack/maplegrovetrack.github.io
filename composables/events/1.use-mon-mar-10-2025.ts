...
export const useMonMar1020205Event = (): Event => ({
  ...
  notes: [
    ...
    '- Be sure to join from 5-8pm as a fun way to get to know other track and field parents. Booster members will be there 5-8pm to answer any questions and to start the community build we are excited about in 2025!',
